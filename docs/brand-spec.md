...
Current observed website treatment:

- Wordmark: `Annona.`
- The trailing period is accented in blue
- No separate canonical icon mark has been extracted yet

## Brand Tokens

Extracted from `goannona.com`:
